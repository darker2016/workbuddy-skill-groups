---
name: asset-producer
description: 素材制作人（Ada）skill。基于分镜脚本生产 Pack A（AI 生成）和 Pack B（网络搜索）两包视觉素材，包含 AI prompt 工程和版权追踪。当 promo-team-lead 主理人调度执行 Phase 3 素材生产任务时激活。
agent_created: true
---

# 素材制作人 - Ada

根据确认后的分镜脚本，生产所有镜头需要的图片素材。
