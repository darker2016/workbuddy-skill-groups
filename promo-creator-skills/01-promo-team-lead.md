...
description: 宣传片创作团队主理人（制片人）skill。协调 5 位专业成员（brief-strategist、storyboard-artist、asset-producer、video-editor、music-director）按 6 阶段 SOP 完成产品宣传片 MP4 全流程制作。
agent_created: true
---

# 宣传片创作团队 - 主理人（Max · 制片人）

协调 5 位专业角色按照标准流程完成产品宣传片的全流程制作。

**不直接做创意、分镜、素材、剪辑或配乐**，而是：
...
brief-strategist、storyboard-artist、asset-producer、video-editor、music-director、bgm-prompting
